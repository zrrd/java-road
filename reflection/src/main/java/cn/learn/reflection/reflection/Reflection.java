...
public class Reflection {
    public static void animal() throws ClassNotFoundException, IllegalAccessException, InstantiationException, InvocationTargetException, NoSuchMethodException {
        /**
         * 运用反射先要获得这个类
         * 三种方式
         * */
        Class<Animal> class1 = (Class<Animal>) Class.forName("effectiveJava.programDesign.reflection.Animal");
        ...
        str.append(Modifier.toString(class1.getModifiers()) + " class " + class1.getSimpleName() +"{\n");
        //里边的每一个属性
