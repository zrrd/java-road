...
public class Message {
  ...
  /**
   * Writes data from the ByteBuffer into this message - meaning into the buffer backing this
   * message.
   *
  ...
  /**
   * Writes data from the byte array into this message - meaning into the buffer backing this
   * message.
   *
  ...
  /**
   * In case the buffer backing the nextMessage contains more than one HTTP message, move all data
   * after the first message to a new Message object.
   *
   * @param message The message containing the partial message (after the first message).
   * @param endIndex The end index of the first message in the buffer of the message given as
   * parameter.
   */
